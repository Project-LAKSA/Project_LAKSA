...
class HealthMonitor(Node):
    ...
    def _publish(self) -> None:
        ...
        health = {
            ...
            "vesc": {"connected": bool(vesc and vesc.telemetry_fresh and self._fresh("vesc_topic", 2.0)), "age_sec": self._age("vesc_topic"), "fault_code": int(vesc.fault_code) if vesc else None, "brake_active": getattr(vesc, "brake_active", None) if vesc else None, "measured_erpm": round(float(vesc.measured_erpm), 1) if vesc else None},
