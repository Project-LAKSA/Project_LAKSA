...
setup(
    ...
    data_files=[
        ...
        ("share/" + package_name + "/web", glob("web/*.html") + glob("web/*.css") + glob("web/*.js") + glob("web/*.mjs")),
        ("share/" + package_name + "/web/vendor", glob("web/vendor/*")),
    ],
    install_requires=["setuptools", "aiohttp", "numpy", "PyYAML"], zip_safe=True,
    maintainer="Project LAKSA", maintainer_email="project-laksa@invalid.local",
    description="Mobile-first PROJECT LAKSA Field Lab.", license="Apache-2.0",
