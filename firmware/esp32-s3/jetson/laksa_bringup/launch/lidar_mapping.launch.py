...
def generate_launch_description():
    ...
    legacy_lidar_tf = LaunchConfiguration("legacy_lidar_tf")
    ...
    lidar_transform = Node(
        ...
        output="screen",
        condition=IfCondition(legacy_lidar_tf),
        arguments=[
            "--x", "0.31542",
            "--y", "0.0",
            "--z", "0.13542",
    ...
    return LaunchDescription(
        [
            DeclareLaunchArgument(
                "enable_mapping",
                default_value="true",
                description="Start legacy RF2O and SLAM Toolbox mapping nodes",
            ),
            DeclareLaunchArgument(
                "serial_port",
            ...
            DeclareLaunchArgument(
                "legacy_lidar_tf",
                default_value="false",
                description="Explicit old-demo compatibility: publish laksa_base_footprint -> laksa_lidar",
            ),
            DeclareLaunchArgument(
                "raw_scan_topic",
